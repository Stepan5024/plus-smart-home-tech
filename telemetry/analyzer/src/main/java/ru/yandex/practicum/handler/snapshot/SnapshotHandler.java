...
public class SnapshotHandler {
    ...
    public void handle(SnapshotAvro snapshot) {
    ...
    private boolean isStart(Scenario scenario, SnapshotAvro snapshot) {
    ...
    private boolean checkCondition(Condition condition, SnapshotAvro snapshot) {
